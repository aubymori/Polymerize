...
class Network
{
    ...
    /**
     * Contains the regular InnerTUbe context.
     */
    protected static object $innertubeContext;
    ...
    ): Promise/*<IResponse>*/
    {
        ...
        $body = (object)($body + [ "context" => self::$innertubeContext ]);

        $requestHeaders = [
            "Content-Type" => "application/json",
            "Cookie" => $_SERVER["HTTP_COOKIE"] // Needed for auth
        ];
                 ...
                 $requestHeaders)
        {
            ...
            )->then(function ($response) use ($resolve, $reject, $ignoreErrors, $body, $requestHeaders) {
    ...
    public static function setInnertubeContext(object $innertubeContext): void
    {
        self::$innertubeContext = $innertubeContext;
    }

    public static function setInnertubeHeaders(array $headers): void
    {
        foreach ($headers as $key => $value)
        if (!is_null($value))
        {
            self::$innertubeHeaders[$key] = $value;
        }
    }
