...
/**
 * Implements the Polymerize autoloader.
 * 
 * @version 2.0
...
class Autoloader
{
    ...
    public static function autoload(string $class): void
    {
        ...
        if (
            ...
            self::mapPrefix($PATH, "Polymerize/Model/", "models/", $f) ||
            self::mapPrefix($PATH, "Polymerize/Controller/", "controllers/", $f)
        )
        {
